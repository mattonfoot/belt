...
function deleteResourceById( schema, id ) {
    var that = this;

    return new Promise(function( resolve, reject ) {
        that.get( schema, id )
            .then(function( resource ) {
                return that.repositories[ schema ].remove( id );
            })
...
Belt.prototype = {
  ...
  , delete: function( schema, ids ) {
        var that = this;

        if ( Array.isArray(ids) ) {
            var promises = ids.map(function( id ) {
                return deleteResourceById.call( that, schema, id );
            });
        ...
        return deleteResourceById.call( that, schema, ids )
            .catch(function( error ) {
                throw new Error( error.message );
            });
    }
