...
Repository.prototype.create = function( model, id, resource ) {
    ...
    return new Promise(function ( resolve, reject ) {
      model.post( resource, function ( error, resource ) {
...
Repository.prototype.update = function( model, id, update ) {
    ...
    return new Promise(function (resolve, reject) {
      model.put( update, id, function ( error, resource ) {
        if (error) return reject(error);
...
function _updateOneToOne( relatedModel, resource, reference, field ) {
  ...
  return new Promise(function (resolve, reject) {
    relatedModel.patch( find, dissociate, function ( error, responses ) {
      if (error) return reject(error);
  ...
  .then(function() {
    ...
    return new Promise(function ( resolve, reject ) {
      relatedModel.patch({ keys: key }, associate, function ( error, responses ) {
        if ( error ) return reject( error );
